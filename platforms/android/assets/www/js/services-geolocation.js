...
//////////////////////////////////////////////
// 
// airQ App - Service GeoLocation
//
//

var service = angular.module('heat.geolocation', []);

// Geolocation
service.factory('Geolocation', function ($localstorage, $http, turf, _, GEO) {
  ...
  var geolocation = {
    ...
    address: function (callback) {
      ...
      var url = MAPQUEST.url + 'reverse?key=' + MAPQUEST.key + '&location=' + location.latitude + ',' + location.longitude;
      console.log('get address by: ' + url);
      ...
      $http.get(url).
        success(function(data, status, headers, config) {
            ...
            if (typeof callback === 'function') {
              ...
              // var address = result.street + ', ' + result.adminArea5 + ', ' + result.adminArea4;
    ...
    nearest: function (geojson, callback) {
        
        var position = geolocation.location();

        console.log('Data GeoJson: ' + _.size(geojson.features))
        ...
        var nearest = turf.nearest(point, geojson);
